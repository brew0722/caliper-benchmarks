...
class OperationBase extends WorkloadModuleBase {
    ...
    * @param {Object} sutContext The custom context object provided by the SUT
    adapter. 
    * @async
    ...
    */
    async initializeWorkloadModule(workerIndex, totalworkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        this.assertSetting('mintAmount'); 
        this.assertSetting('mintOwner');
        this.assertSetting('moneyToTransfer');

        this.mintAmount = this.roundArguments.mintAmount; 
        this.mintOwner = this.roundArguments. mintOwner; 
...
* @param {object} args The object containing the arguments. 77 
...
createConnectorRequest(operation, args) {
    switch (this.connectorType) {
        ...
        default:
            ...
            throw new Error('Connectortype ${ this.connectorType } is not supported by the benchmark');
}
}
